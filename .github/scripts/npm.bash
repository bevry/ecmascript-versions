...
# Publish to npm
# Based from: https://github.com/bevry-archive/awesome-travis/blob/master/scripts/node-publish.bash
...
# env:
#
#   # Specify your npm authorisation token
#   NPM_AUTH_TOKEN: ${{secrets.NPM_AUTH_TOKEN}}
#
#   # Optional: Specify which branch should be published to npm as which tag
#   NPM_BRANCH_TAG: "master:next"
#
#   # Optional: Specify your bevry cdn authorisation token
#   BEVRY_CDN_TOKEN: ${{secrets.BEVRY_CDN_TOKEN}}
